...
public enum ResponseEnum implements StatusCode{
    ...
    SUCCESS(002000, "请求操作成功"),
    SUCCESS_DATA_NULL(002004, "请求成功,响应数据为空"),
    VALIDATE_ERROR(00412, "precondition.failed"),
    ...
    SERVICE_INVOCATION_ERROR(6666,  "service.invocation.error"),
