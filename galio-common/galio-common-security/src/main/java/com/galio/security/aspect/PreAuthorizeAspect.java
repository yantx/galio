...
public class PreAuthorizeAspect {
     ...
     */
    public static final String POINTCUT_SIGN = " @annotation(com.galio.security.annotation.RequiresLogin) || "
            + "@annotation(com.galio.security.annotation.RequiresPermissions) || "
            + "@annotation(com.galio.security.annotation.RequiresRoles)";
