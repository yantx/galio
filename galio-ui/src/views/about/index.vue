      ...
      <n-descriptions bordered label-placement="left" class="py-2">
        ...
        <n-descriptions-item label="文档地址">
          <div class="flex items-center">
            <a href="https://github.com/yantx/galio" class="py-2" target="_blank">查看文档地址</a>
          </div>
        </n-descriptions-item>
        <n-descriptions-item label="预览地址">
          <div class="flex items-center">
            <a href="https://github.com/yantx/galio" class="py-2" target="_blank">查看预览地址</a>
          </div>
        </n-descriptions-item>
        <n-descriptions-item label="Github">
          <div class="flex items-center">
            <a href="https://github.com/yantx/galio" class="py-2" target="_blank"
              >查看Github地址</a
            >
          </div>
        </n-descriptions-item>
